...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Fetch academic papers based on search parameters.")
    parser.add_argument("--json_file_name", type=str,
                        default=f"papers_{int(time.time())}.json", help="The name of the JSON file to save the fetched papers.")
    parser.add_argument("--keyword", type=str, default="cancer",
    ...
    pm_fetcher.run(args.json_file_name, search_params_pm,
